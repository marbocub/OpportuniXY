...
TopIdlerType = GT2x20x5_plain_idler;
MotorType=NEMA17_34;
MotorBeltGap = 1;
...
coreXY_2GT_mixed_idler = list_set(list_set(
    ...
    [
        ...
        TopIdlerType,           // return top
        TopIdlerType,           // motor bottom
        TopIdlerType            // motor top
    ]),
    MOTOR_POSITION,
    [
        [ TopIdlerXOffset, -TopIdlerYOffset],
        [ MotorXOffset, -MotorYOffset],
        [-MotorXOffset, -MotorYOffset]
    ]
);
